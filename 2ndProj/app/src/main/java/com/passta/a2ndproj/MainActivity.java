...
public class MainActivity extends AppCompatActivity {
    ...
    public void setData() {
        ...
        msgDataList.add(new Msg_VO("2020년 11월 6일", "오후 8시 23분", "해외 유입 확진자가 증가 추세로 해외 입국이 예정되어 있는 가족 및" +
                " 외국인근로자가 있을 경우 반드시 완도군보건의료원로 신고 바랍니다", "[완도군청]", 1));
        msgDataList.add(new Msg_VO("2020년 11월 6일", "오후 8시 23분", "367~369번 확진자 발생. 거주지 등 방역 완료. 코로나19 관련 안내 홈페이지" +
                " 참고바랍니다.", "[성북군청]", 1));
        msgDataList.add(new Msg_VO("2020년 11월 5일","오후 8시 23분", "11.8일 2명, 11.9일 4명 확진자 추가 발생." +
                " 상세내용 추후 시홈페이지에 공개예정입니다. corona.seongnam.go.kr", "[성남시청]", 3));
        msgDataList.add(new Msg_VO("2020년 11월 5일","오후 8시 23분", "해외 유입 확진자가 증가 추세로 해외 입국이 예정되어 있는 가족 및" +
                " 외국인근로자가 있을 경우 반드시 완도군보건의료원로 신고 바랍니다", "[완도군청]", 2));
        msgDataList.add(new Msg_VO("2020년 11월 5일","오후 8시 23분", "11.8일 2명, 11.9일 4명 확진자 추가 발생." +
                " 상세내용 추후 시홈페이지에 공개예정입니다. corona.seongnam.go.kr", "[성남시청]", 3));
        msgDataList.add(new Msg_VO("2020년 11월 4일","오후 8시 23분", "해외 유입 확진자가 증가 추세로 해외 입국이 예정되어 있는 가족 및" +
                " 외국인근로자가 있을 경우 반드시 완도군보건의료원로 신고 바랍니다", "[완도군청]", 2));
        msgDataList.add(new Msg_VO("2020년 11월 4일","오후 8시 23분", "해외 유입 확진자가 증가 추세로 해외 입국이 예정되어 있는 가족 및" +
                " 외국인근로자가 있을 경우 반드시 완도군보건의료원로 신고 바랍니다", "[완도군청]", 1));
        msgDataList.add(new Msg_VO("2020년 11월 3일","오후 8시 23분", "367~369번 확진자 발생. 거주지 등 방역 완료. 코로나19 관련 안내 홈페이지" +
                " 참고바랍니다.", "[성북군청]", 1));
        msgDataList.add(new Msg_VO("2020년 11월 3일","오후 8시 23분", "367~369번 확진자 발생. 거주지 등 방역 완료. 코로나19 관련 안내 홈페이지" +
                " 참고바랍니다.", "[성북군청]", 2));
        msgDataList.add(new Msg_VO("2020년 11월 3일","오후 8시 23분", "367~369번 확진자 발생. 거주지 등 방역 완료. 코로나19 관련 안내 홈페이지" +
