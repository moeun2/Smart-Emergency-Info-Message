...
//    @POST("/user/login")
//    Call<ResponseBody> userLogin(@Body LoginData data);
//
//    @POST("/user/selectStudent")
//    Call<ResponseBody> selectStudent(@Query("teacher_id") String teacher_id);
//    @POST("/user/searchStudentId")
//    Call<ResponseBody> searchStudentId(@Body StudentIdSearchData data);
//    @POST("/user/AddStudent")
//    Call<ResponseBody> addStudent(@Body StudentsVO data);
//
...
//
//    @POST("/user/setLectureProgress")
//    Call<ResponseBody> progressLecture(@Body LectureData data);
//    @POST("/user/saveUserTransferData")
//    Call<ResponseBody> saveUserTransferData(@Body CustPayInfoData data);
